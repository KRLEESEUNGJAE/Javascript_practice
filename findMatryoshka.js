...
console.log(findMatryoshka({ size: 10, matryoshka: null }, 10))
console.log(findMatryoshka({ size: 10, matryoshka: null }, 1))
console.log(findMatryoshka({ size: 10, matryoshka: { size: 3, matryoshka: null } }, 3))
console.log(findMatryoshka({ size: 10, matryoshka: { size: 3, matryoshka: null } }, 7))